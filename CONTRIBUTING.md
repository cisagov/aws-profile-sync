...
issue](https://github.com/cisagov/aws-profile-sync/issues) in
...
request](https://github.com/cisagov/aws-profile-sync/pulls),
...
```console
cd aws-profile-sync
pyenv virtualenv <python_version_to_use> aws-profile-sync
pyenv local aws-profile-sync
