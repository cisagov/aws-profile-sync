...
setup(
    ...
    project_urls={
        "Source": "https://github.com/cisagov/aws-profile-sync",
        "Tracker": "https://github.com/cisagov/aws-profile-sync/issues",
    },
    # Author details
    ...
    install_requires=["docopt", "more-itertools", "schema", "setuptools"],
    extras_require={
